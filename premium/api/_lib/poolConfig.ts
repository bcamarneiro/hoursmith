/**
 * Postgres connection pool configuration (ADA-735).
 *
...
/**
 * Map validated pool settings onto `pg.PoolConfig` options. Exported for tests
 * and for consumers that want to construct a raw `Pool` themselves; the
 * `connectionPool` manager uses this when initializing.
 */
